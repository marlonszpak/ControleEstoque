package com.example.ControleEstoque.exceptions;

import java.io.IOException;

import com.example.ControleEstoque.services.exceptions.AuthorizationException;
import com.example.ControleEstoque.services.exceptions.DataBindingViolationException;
import com.example.ControleEstoque.services.exceptions.ObjectNotFoundException;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler implements AuthenticationFailureHandler {
    ...
    private ResponseEntity<Object> buildErrorResponse(
        ...
        if (this.printStackTrace) {
            errorResponse.setStackTrace(ExceptionUtil.getStackTrace(exception));
        }
